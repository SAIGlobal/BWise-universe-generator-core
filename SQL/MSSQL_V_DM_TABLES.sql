CREATE VIEW [dbo].[V_DM_TABLES] AS
WITH REC AS
(
  SELECT
    C.CLASSDEFID
...
SELECT distinct TOP 1000000000   NULL AS DUMMY, * FROM ALL_TABLES


--WHERE CLASSNAME = 'Risk'
--AND DWHTABLENAMESUFFIX = 'ORMRISKASSM'
--AND HEATMAPQUESTION IS NOT NULL
ORDER BY CLASSNAME
GO
